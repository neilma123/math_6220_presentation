...
\begin{frame}{SGD in Hilbert Space}
    ...
    \end{align*}
    where $U = L^2(\Gamma)$, the space of random variables with finite 2nd moment. They show that the for this choice of $\sigma$, $(3)$ approximates $(2)$ with error $\mathcal{O}(\eta^2)$.\\
    % so for very small steps, the discretization of the stochastic modified equation is good.
...
\begin{frame}{$\sigma$ is Local Lipschitz}
    ...
    For any operator $T: U \rightarrow H$, operator norm
    \begin{align*}
...
\begin{frame}{$\sigma$ is Local Lipschitz}
    ...
    \begin{align*}
        ...
        &\leq C_L(\gamma)^2\|\phi - \psi\|^2\\
        \text{taking expectation},\quad \qquad &\\
        &\leq \mathbb{E}_{\gamma}[C_L(\gamma)^2] \|\phi - \psi\|^2
    \end{align*} 
\end{frame}
